...
var bcrypt = require('bcrypt-nodejs'); // IMP: for speed ideally replace this with bcrypt proper when deploying
...
userSchema.methods.comparePassword = function (triedPassword, callback) {
