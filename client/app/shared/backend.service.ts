...
export class BackendService {
	...
	private eventSubtitlePool: string[] = ['Party', 'Burlesque', 'Conference', 'Discussion', 'Lecture', 'Meeting', 'Round Table', 'Viewing', 'Competition', 'Battle', 'and the Sorcerer\'s Stone', 'Class', 'Intervention', 'Brunch', 'Coast to Coast', 'Meditation', 'Fight', 'Teleconference', 'Marathon'];
